<div>
    <form wire:submit.prevent="submit" class="final-form-content">
        ...
        <select id="countries" 
            ...
            <option value="{{ $this->partai->id }}" selected disabled>Partai {{ $this->partai->partai }}</option>
        ...
        <div class="input-count-partai">
            ...
            <div class="input-count-partai__input">
                ...
                <input type="number" value="{{ $this->suarapartai }}" wire:model="suarapartai" class="  focus:ring-0">
                    ...
                    <tr class="table-content-body-row" wire:key="caleg-{{ $i }}">
                        ...
                        <td class="table-content-body__item">
                            <div class="table-input">
                                ...
                                <input type="number" wire:model="suaracalegs.{{ $i }}" value="{{$this->suaracalegs[$i]}}"
            ...
            <tfoot>
                <tr>
                    <td colspan="2" class="table-foot-item text-[10px] lg:text-base">Total Suara (suara partai +
                        suara caleg)</td>
                    <td class="table-foot-item">{{ $this->countall }}</td>
                </tr>
            </tfoot>
        </table>
        {{-- <table class="table-content">
        ...
        <div class="grid grid-cols-1 gap-3 pt-10">
            ...
            <div class=" grid gap-0">
                <img class=" max-h-40" src="{{ url('/storage/lampiran/'.$this->lampiranfile)}}" alt="">
                <input type="file" wire:model="lampiran" value="{{$this->lampiran}}"
                    class="block w-full mt-2 mb-2 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                    id="small_size"></input>
            ...
            <div class="">
                <button wire:loading wire:target="lampiran"
                ...
                <button wire:loading.remove wire:target="lampiran" data-modal-target="popup-modal"
