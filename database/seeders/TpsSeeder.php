...
class TpsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        for ($j=0; $j < $this->mardingding->count() ; $j++) { 
            for ($z=0; $z <$this->mardingding[$j] ; $z++) { 
                \App\Models\Tps::create([
                    'nomortps' => "TPS".sprintf('%02d', $z+1) ,
                    'desa_id' =>  $this->i,
                ]);
        ...
        for ($j=0; $j < $this->simpangempat->count() ; $j++) { 
            for ($z=0; $z <$this->simpangempat[$j] ; $z++) { 
                \App\Models\Tps::create([
                    'nomortps' => "TPS".sprintf('%02d', $z+1) ,
                    'desa_id' =>  $this->i,
                ]);
        ...
        for ($j=0; $j < $this->tigabinanga->count() ; $j++) { 
            for ($z=0; $z <$this->tigabinanga[$j] ; $z++) { 
                \App\Models\Tps::create([
                    'nomortps' => "TPS".sprintf('%02d', $z+1) ,
                    'desa_id' =>  $this->i,
                ]);
        ...
        for ($j=0; $j < $this->tiganderket->count() ; $j++) { 
            for ($z=0; $z <$this->tiganderket[$j] ; $z++) { 
                \App\Models\Tps::create([
                    'nomortps' => "TPS".sprintf('%02d', $z+1) ,
                    'desa_id' =>  $this->i,
                ]);
